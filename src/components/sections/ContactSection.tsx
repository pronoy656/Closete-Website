...
//           <div className="absolute top-0 right-0 w-96 h-96 -translate-y-1/4 translate-x-1/4 pointer-events-none rounded-full" style={{ background: 'radial-gradient(circle, rgba(139, 92, 246, 0.25) 0%, transparent 70%)' }} />
//           <div className="absolute bottom-0 left-0 w-96 h-96 translate-y-1/4 -translate-x-1/4 pointer-events-none rounded-full" style={{ background: 'radial-gradient(circle, rgba(168, 85, 247, 0.25) 0%, transparent 70%)' }} />
