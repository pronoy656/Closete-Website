...
export function VisionSection() {
  return (
    <section id="our-vision" className="relative w-full bg-[#0a0a0a] text-white flex flex-col items-center justify-center overflow-hidden px-6 pt-16 md:pt-24 pb-24 font-sans">
